...
Este documento establece aclaraciones generales sobre el uso del repositorio Banco Digital Accesible.

Banco Digital Accesible es un proyecto educativo digital personal, sin fines de lucro, desarrollado y organizado por Gabriel Berrospi como recurso de apoyo para la accesibilidad, la inclusión educativa y la atención a la diversidad.

## Alcance del proyecto

El repositorio tiene finalidad educativa, informativa y de apoyo pedagógico. No reemplaza la evaluación profesional, la intervención especializada, la planificación docente, la enseñanza formal de sistemas comunicativos ni los ajustes razonables que cada estudiante pueda requerir.

Los recursos integrados deben utilizarse como apoyo complementario y adaptarse al contexto educativo, a las características de los estudiantes y a las necesidades de apoyo identificadas.
...
El proyecto tiene finalidad educativa y no comercial. El uso comercial del código, diseño, estructura, materiales integrados o contenidos asociados requiere autorización correspondiente y respeto a las licencias de terceros.
